...
export const $layout = scope({
	...
	FieldPlan: {
		...
		size: "number",
		paddingAfter: "number",
		// Migration metadata — only present when the source uses the marker /
		// an ArkType default. Consumed by the diff classifier (diffPlans).
		"renamedFrom?": "string",
	...
	EnumPlan: {
		...
		"obsoleteReason?": "string",
		"renamedFrom?": "string",
		"synthetic?": "boolean", // Was this type generated by analyzer?
	},
