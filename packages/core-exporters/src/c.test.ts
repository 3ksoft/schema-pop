			...
			types: [
				{
					...
					fields: [
						{
							name: "len",
							type: { kind: "primitive", name: "u32", size: 4, align: 4, paddedSize: 4 },
							offset: 0, size: 4, bitOffset: 0, bitSize: 32, paddingAfter: 0,
						},
						{
							name: "count",
							type: { kind: "any", originalType: "size_t" },
							offset: 8, size: 8, bitOffset: 0, bitSize: 64, paddingAfter: 0,
						},
						{
							name: "label",
							type: { kind: "any", originalType: "char[16]" },
							offset: 16, size: 16, bitOffset: 0, bitSize: 128, paddingAfter: 0,
						},
					],
				},
			],
